...
/**
 * Builds the beatmap artwork fallback chain, highest quality first:
 * raw -> cover@2x -> cover -> slimcover@2x.
 */
...
/** Converts a raw osu! API score into the normalized ThumbnailData model. */
export function normalizeScore(
  ...
  // Misses and slider breaks are separate counters: a miss is a full miss.
  // The API has no dedicated slider-break counter; in lazer only large tick
  // misses correspond to actual slider breaks (small ticks do not).
